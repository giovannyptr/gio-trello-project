      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3 sm:py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <Trello className="h-6 w-6 sm:h-8 sm:w-8 text-pink-600" />
    ...
    return <header className="bg-white border-b sticky top-0 z-50">
      <div className="container mx-auto px-4 py-3 sm:-py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center pace-x-2 sm:space-x-4 min-w-0">
            ...
            <div className="flex items-canter space-x-1 sm:space-x-2 min-w-0">
              <Trello className="text-pink-600" />
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 flex-shrink-0">
            {onFilterClick && (
              <Button
                variant="outline"
                size="sm"
                className={`text-xs sm:text-sm ${filterCount > 0 ? "bg-pink-100 border-pink-200" : ""
                  }`}
              ...
              >
                ...
                {filterCount > 0 && (
                  <Badge
                    variant="secondary"
                    className="text-xs ml-1 sm:ml-2 bg-pink-100 border-pink-200"
                  >
                    {filterCount}
                  </Badge>
                )}
